...
class ScratchController extends AbstractController
{
  ...
  /**
   * @Route("/scratch/search/projects", name="search_scratch_program", methods={"GET"}, defaults={"q": "", "offset": 0, "limit": 40})
   *
   * Returns a list of the found programs. Scratch doesn't return the number of total found projects.
   * Total_programs is set to null if the number of found programs isn't known yet.
   */
